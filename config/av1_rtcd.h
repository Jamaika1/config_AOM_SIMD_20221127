...
void av1_dist_wtd_convolve_x_sse2(const uint8_t* src,
                                  ...
                                  const int subpel_x_qn,
                                  ConvolveParams* conv_params);
RTCD_EXTERN void (*av1_dist_wtd_convolve_x)(const uint8_t* src,
                                  int src_stride,
                                  uint8_t* dst,
                                  int dst_stride,
                                  int w,
...
void av1_dist_wtd_convolve_y_sse2(const uint8_t* src,
                                  ...
                                  const int subpel_y_qn,
                                  ConvolveParams* conv_params);
RTCD_EXTERN void (*av1_dist_wtd_convolve_y)(const uint8_t* src,
                                  int src_stride,
                                  uint8_t* dst,
                                  int dst_stride,
                                  int w,
...
/*#if defined(__SSE2__)
void av1_fwht4x4_sse2(const int16_t* input, tran_low_t* output, int stride);
#endif*/
#if defined(__SSE4_1__)
...
void av1_quantize_fp_ssse3(const tran_low_t* coeff_ptr,
                          intptr_t n_coeffs,
                          const int16_t* zbin_ptr,
                          const int16_t* round_ptr,
                          const int16_t* quant_ptr,
...
/*#if defined(__SSSE3__) && defined(__x86_64__)
void av1_quantize_fp_32x32_ssse3(const tran_low_t* coeff_ptr,
                                intptr_t n_coeffs,
                                const int16_t* zbin_ptr,
                                const int16_t* round_ptr,
                                const int16_t* quant_ptr,
...
void av1_build_compound_diffwtd_mask_highbd_ssse3(uint8_t *mask,
                                                  ...
                                                  int w,
                                                  int bd);
RTCD_EXTERN void (*av1_build_compound_diffwtd_mask_highbd)(uint8_t *mask,
                                                  DIFFWTD_MASK_TYPE mask_type,
                                                  const uint8_t *src0,
                                                  int src0_stride,
                                                  const uint8_t *src1,
...
void aom_highbd_dist_wtd_comp_avg_upsampled_pred_c(MACROBLOCKD *xd,
                                                   const struct AV1Common *const cm,
                                                   int mi_row,
                                                   int mi_col,
                                                   const MV *const mv,
                                                   ...
                                                   int subpel_search);
#if defined(__SSE2__) && HAVE_SIMD
void aom_highbd_dist_wtd_comp_avg_upsampled_pred_sse2(MACROBLOCKD *xd,
                                                      const struct AV1Common *const cm,
                                                      int mi_row,
                                                      int mi_col,
                                                      const MV *const mv,
...
void av1_highbd_convolve_2d_sr_ssse3(const uint16_t *src,
                                 ...
                                 ConvolveParams *conv_params,
                                 int bd);
RTCD_EXTERN void (*av1_highbd_convolve_2d_sr)(const uint16_t *src,
                                 int src_stride,
                                 uint16_t *dst,
                                 int dst_stride,
                                 int w,
...
void av1_highbd_convolve_x_sr_ssse3(const uint16_t *src,
                                ...
                                ConvolveParams *conv_params,
                                int bd);
RTCD_EXTERN void (*av1_highbd_convolve_x_sr)(const uint16_t *src,
                                int src_stride,
                                uint16_t *dst,
                                int dst_stride,
                                int w,
...
void av1_highbd_convolve_y_sr_ssse3(const uint16_t *src,
                                ...
                                const int subpel_y_qn,
                                int bd);
RTCD_EXTERN void (*av1_highbd_convolve_y_sr)(const uint16_t *src,
                                int src_stride,
                                uint16_t *dst,
                                int dst_stride,
                                int w,
...
void av1_highbd_dist_wtd_convolve_2d_c(const uint16_t *src,
                                       int src_stride,
                                       uint16_t *dst,
                                       int dst_stride,
                                       int w,
...
#if HAVE_SIMD
#if defined(__SSE4_1__)
void av1_highbd_dist_wtd_convolve_2d_sse4_1(const uint16_t *src,
                                       int src_stride,
                                       uint16_t *dst,
                                       int dst_stride,
                                       int w,
                                       ...
                                       ConvolveParams *conv_params,
                                       int bd);
RTCD_EXTERN void (*av1_highbd_dist_wtd_convolve_2d)(const uint16_t *src,
                                       int src_stride,
                                       uint16_t *dst,
                                       int dst_stride,
                                       int w,
...
#endif
#if defined(__AVX2__)
void av1_highbd_dist_wtd_convolve_2d_avx2(const uint16_t *src,
                                       int src_stride,
                                       uint16_t *dst,
                                       int dst_stride,
                                       int w,
...
#if HAVE_SIMD
#if defined(__SSE4_1__)
void av1_highbd_dist_wtd_convolve_x_sse4_1(const uint16_t *src,
                                      int src_stride,
                                      uint16_t *dst,
                                      int dst_stride,
                                      int w,
                                      ...
                                      ConvolveParams *conv_params,
                                      int bd);
RTCD_EXTERN void (*av1_highbd_dist_wtd_convolve_x)(const uint16_t *src,
                                      int src_stride,
                                      uint16_t *dst,
                                      int dst_stride,
                                      int w,
...
#endif
#if defined(__AVX2__)
void av1_highbd_dist_wtd_convolve_x_avx2(const uint16_t *src,
                                      int src_stride,
                                      uint16_t *dst,
                                      int dst_stride,
                                      int w,
...
#if HAVE_SIMD
#if defined(__SSE4_1__)
void av1_highbd_dist_wtd_convolve_y_sse4_1(const uint16_t *src,
                                      int src_stride,
                                      uint16_t *dst,
                                      int dst_stride,
                                      int w,
                                      ...
                                      ConvolveParams *conv_params,
                                      int bd);
RTCD_EXTERN void (*av1_highbd_dist_wtd_convolve_y)(const uint16_t *src,
                                      int src_stride,
                                      uint16_t *dst,
                                      int dst_stride,
                                      int w,
...
#endif
#if defined(__AVX2__)
void av1_highbd_dist_wtd_convolve_y_avx2(const uint16_t *src,
                                      int src_stride,
                                      uint16_t *dst,
                                      int dst_stride,
                                      int w,
...
void av1_highbd_dist_wtd_convolve_2d_copy_sse4_1(const uint16_t *src,
                                            ...
                                            ConvolveParams *conv_params,
                                            int bd);
RTCD_EXTERN void (*av1_highbd_dist_wtd_convolve_2d_copy)(const uint16_t *src,
                                            int src_stride,
                                            uint16_t *dst,
                                            int dst_stride,
                                            int w,
...
void av1_highbd_convolve_2d_scale_sse4_1(const uint16_t *src,
                                    ...
                                    ConvolveParams *conv_params,
                                    int bd);
RTCD_EXTERN void (*av1_highbd_convolve_2d_scale)(const uint16_t *src,
                                    int src_stride,
                                    uint16_t *dst,
                                    int dst_stride,
                                    int w,
...
void av1_apply_temporal_filter_sse2(const struct yv12_buffer_config *ref_frame,
                                 ...
                                 uint32_t *accum,
                                 uint16_t *count);
RTCD_EXTERN void (*av1_apply_temporal_filter)(const struct yv12_buffer_config *ref_frame,
                                 const struct macroblockd *mbd,
                                 const BLOCK_SIZE block_size,
                                 const int mb_row,
                                 const int mb_col,
...
#if CONFIG_AV1_HIGHBITDEPTH
void av1_highbd_apply_temporal_filter_c(const struct yv12_buffer_config *ref_frame,
                                        const struct macroblockd *mbd,
                                        const BLOCK_SIZE block_size,
                                        const int mb_row,
                                        const int mb_col,
...
#if HAVE_SIMD
#if defined(__SSE2__)
void av1_highbd_apply_temporal_filter_sse2(const struct yv12_buffer_config *ref_frame,
                                        const struct macroblockd *mbd,
                                        const BLOCK_SIZE block_size,
                                        const int mb_row,
                                        const int mb_col,
                                        ...
                                        uint32_t *accum,
                                        uint16_t *count);
RTCD_EXTERN void (*av1_highbd_apply_temporal_filter)(const struct yv12_buffer_config *ref_frame,
                                        const struct macroblockd *mbd,
                                        const BLOCK_SIZE block_size,
                                        const int mb_row,
                                        const int mb_col,
...
#endif
#if defined(__AVX2__)
void av1_highbd_apply_temporal_filter_avx2(const struct yv12_buffer_config *ref_frame,
                                        const struct macroblockd *mbd,
                                        const BLOCK_SIZE block_size,
                                        const int mb_row,
                                        const int mb_col,
...
int64_t av1_highbd_pixel_proj_error_sse4_1(const uint8_t *src8,
                                      ...
                                      int xq[2],
                                      const sgr_params_type *params);
RTCD_EXTERN int64_t (*av1_highbd_pixel_proj_error)(const uint8_t *src8,
                                      int width,
                                      int height,
                                      int src_stride,
                                      const uint8_t *dat8,
...
int64_t av1_lowbd_pixel_proj_error_sse4_1(const uint8_t *src8,
                                     ...
                                     int xq[2],
                                     const sgr_params_type *params);
RTCD_EXTERN int64_t (*av1_lowbd_pixel_proj_error)(const uint8_t *src8,
                                     int width,
                                     int height,
                                     int src_stride,
                                     const uint8_t *dat8,
...
void av1_cnn_convolve_no_maxpool_padding_valid_c(const float **input,
                                                 int in_width,
                                                 int in_height,
                                                 int in_stride,
                                                 ...
                                                 int cstep,
                                                 int channel_step);
#if HAVE_SIMD && CONFIG_EXCLUDE_SIMD_MISMATCH
RTCD_EXTERN void (*av1_cnn_convolve_no_maxpool_padding_valid)(const float **input,
                                                 int in_width,
                                                 int in_height,
                                                 int in_stride,
                                                 const CNN_LAYER_CONFIG *layer_config,
                                                 ...
                                                 int channel_step);
#if defined(__AVX2__)
void av1_cnn_convolve_no_maxpool_padding_valid_avx2(const float **input,
                                                 int in_width,
                                                 int in_height,
                                                 int in_stride,
                                                 const CNN_LAYER_CONFIG *layer_config,
...
//#if CONFIG_REALTIME_ONLY
  ...
  //av1_cnn_activate = av1_cnn_activate_c;
  //av1_cnn_add = av1_cnn_add_c;
  //av1_cnn_predict = av1_cnn_predict_c;
#if CONFIG_EXCLUDE_SIMD_MISMATCH
  av1_cnn_convolve_no_maxpool_padding_valid = av1_cnn_convolve_no_maxpool_padding_valid_c;
#endif
  //av1_cnn_deconvolve = av1_cnn_deconvolve_c;
  //av1_cnn_batchnorm = av1_cnn_batchnorm_c;
#endif
#if defined(__SSE2__) && HAVE_SIMD
