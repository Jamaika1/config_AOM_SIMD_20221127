...
unsigned int aom_dist_wtd_sad128x128_avg_c(const uint8_t* src_ptr,
     int src_stride,
...
unsigned int aom_dist_wtd_sad128x128_avg_ssse3(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
     const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad128x128_avg)(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad128x64_avg_c(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
     const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad128x64_avg_ssse3(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
     const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad128x64_avg)(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad16x16_avg_c(const uint8_t* src_ptr,
     ...
     const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad16x16_avg_ssse3(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
     const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad16x16_avg)(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad16x32_avg_c(const uint8_t* src_ptr,
     ...
     const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad16x32_avg_ssse3(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
     const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad16x32_avg)(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad16x4_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad16x4_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad16x4_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad16x64_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad16x64_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad16x64_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad16x8_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad16x8_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad16x8_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad32x16_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad32x16_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad32x16_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad32x32_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad32x32_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad32x32_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad32x64_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad32x64_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad32x64_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad32x8_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad32x8_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad32x8_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad4x16_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad4x16_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad4x16_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad4x4_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad4x4_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad4x4_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad4x8_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad4x8_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad4x8_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad64x128_avg_c(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad64x128_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad64x128_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad64x16_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad64x16_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad64x16_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad64x32_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad64x32_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad64x32_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad64x64_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad64x64_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad64x64_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad8x16_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad8x16_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad8x16_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad8x32_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad8x32_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad8x32_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad8x4_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad8x4_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad8x4_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_dist_wtd_sad8x8_avg_c(const uint8_t* src_ptr,
    ...
    const DIST_WTD_COMP_PARAMS* jcp_param);
#if defined(__SSSE3__) && HAVE_SIMD
unsigned int aom_dist_wtd_sad8x8_avg_ssse3(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
    const DIST_WTD_COMP_PARAMS* jcp_param);
RTCD_EXTERN unsigned int (*aom_dist_wtd_sad8x8_avg)(const uint8_t* src_ptr,
    int src_stride,
    const uint8_t* ref_ptr,
    int ref_stride,
    const uint8_t* second_pred,
...
unsigned int aom_highbd_10_obmc_variance128x128_sse4_1(const uint8_t* pre,
   ...
   const int32_t* mask,
   unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance128x128)(const uint8_t* pre,
   int pre_stride,
   const int32_t* wsrc,
   const int32_t* mask,
   unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance128x64_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance128x64)(const uint8_t* pre,
  int pre_stride,
  const int32_t* wsrc,
  const int32_t* mask,
  unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance16x16_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance16x16)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance16x32_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance16x32)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance16x64_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance16x64)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance32x16_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance32x16)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance32x32_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance32x32)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance32x64_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance32x64)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance64x128_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance64x128)(const uint8_t* pre,
  int pre_stride,
  const int32_t* wsrc,
  const int32_t* mask,
  unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance64x16_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance64x16)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance64x32_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance64x32)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_10_obmc_variance64x64_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_10_obmc_variance64x64)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
uint32_t aom_highbd_10_sub_pixel_avg_variance4x4_c(const uint8_t* src_ptr,
   ...
   const uint8_t* second_pred);
#if defined(__SSE4_1__) && HAVE_SIMD
uint32_t aom_highbd_10_sub_pixel_avg_variance4x4_sse4_1(const uint8_t* src_ptr,
   int source_stride,
   int xoffset,
   int yoffset,
   const uint8_t* ref_ptr,
   ...
   uint32_t* sse,
   const uint8_t* second_pred);
RTCD_EXTERN uint32_t (*aom_highbd_10_sub_pixel_avg_variance4x4)(const uint8_t* src_ptr,
   int source_stride,
   int xoffset,
   int yoffset,
   const uint8_t* ref_ptr,
...
int ref_stride,
uint32_t* sse);
RTCD_EXTERN uint32_t (*aom_highbd_10_sub_pixel_variance4x4)(const uint8_t* src_ptr,
int source_stride,
int xoffset,
int yoffset,
const uint8_t* ref_ptr,
...
unsigned int aom_highbd_12_obmc_variance128x128_sse4_1(const uint8_t* pre,
   ...
   const int32_t* mask,
   unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance128x128)(const uint8_t* pre,
   int pre_stride,
   const int32_t* wsrc,
   const int32_t* mask,
   unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance128x64_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance128x64)(const uint8_t* pre,
  int pre_stride,
  const int32_t* wsrc,
  const int32_t* mask,
  unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance16x16_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance16x16)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance16x32_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance16x32)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance16x64_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance16x64)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance32x16_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance32x16)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance32x32_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance32x32)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance32x64_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance32x64)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance64x128_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance64x128)(const uint8_t* pre,
  int pre_stride,
  const int32_t* wsrc,
  const int32_t* mask,
  unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance64x16_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance64x16)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance64x32_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance64x32)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
unsigned int aom_highbd_12_obmc_variance64x64_sse4_1(const uint8_t* pre,
 ...
 const int32_t* mask,
 unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_highbd_12_obmc_variance64x64)(const uint8_t* pre,
 int pre_stride,
 const int32_t* wsrc,
 const int32_t* mask,
 unsigned int* sse);
...
uint32_t aom_highbd_12_sub_pixel_avg_variance4x4_c(const uint8_t* src_ptr,
   ...
   const uint8_t* second_pred);
#if defined(__SSE4_1__) && HAVE_SIMD
uint32_t aom_highbd_12_sub_pixel_avg_variance4x4_sse4_1(const uint8_t* src_ptr,
   int source_stride,
   int xoffset,
   int yoffset,
   const uint8_t* ref_ptr,
   ...
   uint32_t* sse,
   const uint8_t* second_pred);
RTCD_EXTERN uint32_t (*aom_highbd_12_sub_pixel_avg_variance4x4)(const uint8_t* src_ptr,
   int source_stride,
   int xoffset,
   int yoffset,
   const uint8_t* ref_ptr,
...
int ref_stride,
uint32_t* sse);
RTCD_EXTERN uint32_t (*aom_highbd_12_sub_pixel_variance4x4)(const uint8_t* src_ptr,
int source_stride,
int xoffset,
int yoffset,
const uint8_t* ref_ptr,
...
uint32_t aom_highbd_8_sub_pixel_avg_variance4x4_c(const uint8_t* src_ptr,
  ...
  const uint8_t* second_pred);
#if defined(__SSE4_1__) && HAVE_SIMD
uint32_t aom_highbd_8_sub_pixel_avg_variance4x4_sse4_1(const uint8_t* src_ptr,
  int source_stride,
  int xoffset,
  int yoffset,
  const uint8_t* ref_ptr,
  ...
  uint32_t* sse,
  const uint8_t* second_pred);
RTCD_EXTERN uint32_t (*aom_highbd_8_sub_pixel_avg_variance4x4)(const uint8_t* src_ptr,
  int source_stride,
  int xoffset,
  int yoffset,
  const uint8_t* ref_ptr,
...
uint32_t aom_highbd_8_sub_pixel_variance4x4_sse4_1(const uint8_t* src_ptr,
    ...
    int ref_stride,
    uint32_t* sse);
RTCD_EXTERN uint32_t (*aom_highbd_8_sub_pixel_variance4x4)(const uint8_t* src_ptr,
    int source_stride,
    int xoffset,
    int yoffset,
    const uint8_t* ref_ptr,
...
unsigned int aom_highbd_masked_sad128x128_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad128x128_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad128x128_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad128x64_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad128x64_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad128x64_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad16x16_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad16x16_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad16x16_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad16x32_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad16x32_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad16x32_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad16x4_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad16x4_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad16x4_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad16x64_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad16x64_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad16x64_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad16x8_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad16x8_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad16x8_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad32x16_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad32x16_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad32x16_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad32x32_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad32x32_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad32x32_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad32x64_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad32x64_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad32x64_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad32x8_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad32x8_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad32x8_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad4x16_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad4x16_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad4x16_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad4x4_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad4x4_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad4x4_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad4x8_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad4x8_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad4x8_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad64x128_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad64x128_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad64x128_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad64x16_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad64x16_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad64x16_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad64x32_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad64x32_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad64x32_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad64x64_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad64x64_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad64x64_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad8x16_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad8x16_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad8x16_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad8x32_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad8x32_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad8x32_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad8x4_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad8x4_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad8x4_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
unsigned int aom_highbd_masked_sad8x8_c(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_highbd_masked_sad8x8_ssse3(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_highbd_masked_sad8x8_avx2(
    const uint8_t* src8,
    int src_stride,
    const uint8_t* ref8,
    int ref_stride,
...
void aom_highbd_quantize_b_32x32_sse2(const tran_low_t* coeff_ptr,
     ...
     const int16_t* scan,
     const int16_t* iscan);
RTCD_EXTERN void (*aom_highbd_quantize_b_32x32)(const tran_low_t* coeff_ptr,
     intptr_t n_coeffs,
     const int16_t* zbin_ptr,
     const int16_t* round_ptr,
     const int16_t* quant_ptr,
...
#endif
#if defined(__AVX2__)
void aom_highbd_quantize_b_32x32_avx2(const tran_low_t* coeff_ptr,
     intptr_t n_coeffs,
     const int16_t* zbin_ptr,
     const int16_t* round_ptr,
     const int16_t* quant_ptr,
...
void aom_highbd_quantize_b_64x64_sse2(const tran_low_t* coeff_ptr,
     ...
     const int16_t* scan,
     const int16_t* iscan);
RTCD_EXTERN void (*aom_highbd_quantize_b_64x64)(const tran_low_t* coeff_ptr,
     intptr_t n_coeffs,
     const int16_t* zbin_ptr,
     const int16_t* round_ptr,
     const int16_t* quant_ptr,
...
#endif
#if defined(__AVX2__)
void aom_highbd_quantize_b_64x64_avx2(const tran_low_t* coeff_ptr,
     intptr_t n_coeffs,
     const int16_t* zbin_ptr,
     const int16_t* round_ptr,
     const int16_t* quant_ptr,
...
void aom_highbd_quantize_b_adaptive_sse2(const tran_low_t* coeff_ptr,
     ...
     const int16_t* scan,
     const int16_t* iscan);
RTCD_EXTERN void (*aom_highbd_quantize_b_adaptive)(const tran_low_t* coeff_ptr,
     intptr_t n_coeffs,
     const int16_t* zbin_ptr,
     const int16_t* round_ptr,
     const int16_t* quant_ptr,
...
void aom_highbd_quantize_b_32x32_adaptive_sse2(const tran_low_t* coeff_ptr,
     ...
     const int16_t* scan,
     const int16_t* iscan);
RTCD_EXTERN void (*aom_highbd_quantize_b_32x32_adaptive)(const tran_low_t* coeff_ptr,
     intptr_t n_coeffs,
     const int16_t* zbin_ptr,
     const int16_t* round_ptr,
     const int16_t* quant_ptr,
...
unsigned int aom_highbd_sad128x128_avg_c(const uint8_t* src_ptr,
     ...
     const uint8_t* second_pred);
#if HAVE_SIMD
RTCD_EXTERN unsigned int (*aom_highbd_sad128x128_avg)(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred);
...
unsigned int aom_highbd_sad128x64_avg_c(const uint8_t* src_ptr,
     ...
     const uint8_t* second_pred);
#if HAVE_SIMD
RTCD_EXTERN unsigned int (*aom_highbd_sad128x64_avg)(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred);
...
unsigned int aom_highbd_sad64x128_avg_c(const uint8_t* src_ptr,
     ...
     const uint8_t* second_pred);
#if HAVE_SIMD
RTCD_EXTERN unsigned int (*aom_highbd_sad64x128_avg)(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* ref_ptr,
     int ref_stride,
     const uint8_t* second_pred);
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad128x128_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad128x128)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad128x128_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad128x64_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad128x64_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad128x64)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad128x64_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad16x16_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad16x16_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad16x16)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad16x16_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad16x32_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad16x32_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad16x32)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad16x32_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad16x4_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad16x4_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad16x4)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad16x4_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad16x64_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad16x64_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad16x64)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad16x64_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad16x8_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad16x8_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad16x8)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad16x8_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad32x16_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad32x16)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad32x16_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad32x32_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad32x32_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad32x32)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad32x32_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad32x64_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad32x64_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad32x64)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad32x64_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad32x8_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad32x8_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad32x8)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad32x8_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad4x16_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad4x16_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad4x16)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad4x16_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad4x4_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad4x4_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad4x4)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad4x4_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad4x8_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad4x8_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad4x8)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad4x8_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad64x128_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad64x128)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad64x128_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad64x16_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad64x16_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad64x16)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad64x16_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad64x32_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad64x32_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad64x32)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad64x32_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad64x64_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad64x64)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad64x64_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad8x16_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad8x16)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad8x16_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
unsigned int aom_masked_sad8x32_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad8x32_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad8x32)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad8x32_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad8x4_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad8x4)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad8x4_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#if HAVE_SIMD
#if defined(__SSSE3__)
unsigned int aom_masked_sad8x8_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
    ...
    int msk_stride,
    int invert_mask);
RTCD_EXTERN unsigned int (*aom_masked_sad8x8)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
#endif
#if defined(__AVX2__)
unsigned int aom_masked_sad8x8_avx2(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref,
    int ref_stride,
...
void aom_masked_sad128x128x4d_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad128x128x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad128x128x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad128x64x4d_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad128x64x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad128x64x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad16x16x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad16x16x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad16x16x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad16x32x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad16x32x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad16x32x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad16x4x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad16x4x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad16x4x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad16x64x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad16x64x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad16x64x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad16x8x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad16x8x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad16x8x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad32x16x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad32x16x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad32x16x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad32x32x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad32x32x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad32x32x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad32x64x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad32x64x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad32x64x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad32x8x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad32x8x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad32x8x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad4x16x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad4x16x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad4x16x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad4x4x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad4x4x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad4x4x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad4x8x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad4x8x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad4x8x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad64x128x4d_c(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad64x128x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad64x128x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad64x16x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad64x16x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad64x16x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad64x32x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad64x32x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad64x32x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad64x64x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad64x64x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad64x64x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad8x16x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad8x16x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad8x16x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad8x32x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad8x32x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad8x32x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad8x4x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad8x4x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad8x4x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
void aom_masked_sad8x8x4d_c(
    ...
    unsigned sads[4]);
#if defined(__SSSE3__) && HAVE_SIMD
void aom_masked_sad8x8x4d_ssse3(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
    ...
    int invert_mask,
    unsigned sads[4]);
RTCD_EXTERN void (*aom_masked_sad8x8x4d)(
    const uint8_t* src,
    int src_stride,
    const uint8_t* ref[4],
    int ref_stride,
...
unsigned int aom_obmc_sub_pixel_variance128x128_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance128x128)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance128x64_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance128x64)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance16x16_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance16x16)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance16x32_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance16x32)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance16x64_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance16x64)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance32x16_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance32x16)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance32x32_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance32x32)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance32x64_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance32x64)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance64x128_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance64x128)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance64x16_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance64x16)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance64x32_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance64x32)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
unsigned int aom_obmc_sub_pixel_variance64x64_sse4_1(const uint8_t* pre,
  ...
  const int32_t* mask,
  unsigned int* sse);
RTCD_EXTERN unsigned int (*aom_obmc_sub_pixel_variance64x64)(const uint8_t* pre,
  int pre_stride,
  int xoffset,
  int yoffset,
  const int32_t* wsrc,
...
void aom_sad4x32x4d_c(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* const ref_ptr[4],
     int ref_stride,
     uint32_t sad_array[4]);
#if defined(__SSE2__) && HAVE_SIMD
void aom_sad4x32x4d_sse2(const uint8_t* src_ptr,
     int src_stride,
     const uint8_t* const ref_ptr[4],
     int ref_stride,
     uint32_t sad_array[4]);
#define aom_sad4x32x4d aom_sad4x32x4d_sse2
#else
#define aom_sad4x32x4d aom_sad4x32x4d_c
#endif
...
#if defined(__SSE2__) && defined(__x86_64__) && HAVE_SIMD
...
#if defined(__SSE2__) && defined(__x86_64__) && HAVE_SIMD && CONFIG_INTERNAL_STATS
void aom_ssim_parms_16x16_sse2(const uint8_t *s, int sp, const uint8_t *r, int rp, uint32_t *sum_s, uint32_t *sum_r, uint32_t *sum_sq_s, uint32_t *sum_sq_r, uint32_t *sum_sxr);
#define aom_ssim_parms_16x16 aom_ssim_parms_16x16_sse2
#else
...
static void setup_rtcd_internal(void) {
  ...
  //aom_ssim_parms_8x8 = aom_ssim_parms_8x8_sse2; //SSE2
#if CONFIG_INTERNAL_STATS
  //aom_ssim_parms_16x16 = aom_ssim_parms_16x16_sse2; //SSE2
#endif
#endif
  //
...
#if defined(__SSSE3__) && HAVE_SIMD
#if defined(__x86_64__)
  if (flags & HAS_SSSE3) aom_fdct8x8 = aom_fdct8x8_ssse3; //SSSE3
  if (flags & HAS_SSSE3) aom_quantize_b = aom_quantize_b_ssse3; //SSSE3
  if (flags & HAS_SSSE3) aom_quantize_b_32x32 = aom_quantize_b_32x32_ssse3; //SSSE3
#endif
  if (flags & HAS_SSSE3) aom_convolve8_horiz = aom_convolve8_horiz_ssse3; // AVX2
  if (flags & HAS_SSSE3) aom_convolve8_vert = aom_convolve8_vert_ssse3; // AVX2
  if (flags & HAS_SSSE3) aom_scaled_2d = aom_scaled_2d_ssse3; // AVX2
  ...
  //if (flags & HAS_AVX2) aom_convolve8_horiz = aom_convolve8_horiz_ssse3; // AVX2
  //if (flags & HAS_AVX2) aom_convolve8_vert = aom_convolve8_vert_ssse3; // AVX2
  //if (flags & HAS_AVX2) aom_scaled_2d = aom_scaled_2d_ssse3; // AVX2
  if (flags & HAS_AVX2) aom_convolve8_horiz = aom_convolve8_horiz_avx2; // AVX2
  if (flags & HAS_AVX2) aom_convolve8_vert = aom_convolve8_vert_avx2; // AVX2
  ...
  //
  if (flags & HAS_AVX2) aom_dc_top_predictor_32x16 = aom_dc_top_predictor_32x16_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_top_predictor_32x32 = aom_dc_top_predictor_32x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_top_predictor_32x64 = aom_dc_top_predictor_32x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_top_predictor_64x64 = aom_dc_top_predictor_64x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_top_predictor_64x32 = aom_dc_top_predictor_64x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_top_predictor_64x16 = aom_dc_top_predictor_64x16_avx2; //avx2/;
  //
  if (flags & HAS_AVX2) aom_dc_left_predictor_32x16 = aom_dc_left_predictor_32x16_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_left_predictor_32x32 = aom_dc_left_predictor_32x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_left_predictor_32x64 = aom_dc_left_predictor_32x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_left_predictor_64x64 = aom_dc_left_predictor_64x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_left_predictor_64x32 = aom_dc_left_predictor_64x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_left_predictor_64x16 = aom_dc_left_predictor_64x16_avx2; //avx2/;
  //
  if (flags & HAS_AVX2) aom_dc_128_predictor_32x16 = aom_dc_128_predictor_32x16_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_128_predictor_32x32 = aom_dc_128_predictor_32x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_128_predictor_32x64 = aom_dc_128_predictor_32x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_128_predictor_64x64 = aom_dc_128_predictor_64x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_128_predictor_64x32 = aom_dc_128_predictor_64x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_128_predictor_64x16 = aom_dc_128_predictor_64x16_avx2; //avx2/;
  //
  if (flags & HAS_AVX2) aom_v_predictor_32x16 = aom_v_predictor_32x16_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_v_predictor_32x32 = aom_v_predictor_32x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_v_predictor_32x64 = aom_v_predictor_32x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_v_predictor_64x64 = aom_v_predictor_64x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_v_predictor_64x32 = aom_v_predictor_64x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_v_predictor_64x16 = aom_v_predictor_64x16_avx2; //avx2/;
  //
  if (flags & HAS_AVX2) aom_h_predictor_32x32 = aom_h_predictor_32x32_avx2; //avx2/;
  //
  if (flags & HAS_AVX2) aom_dc_predictor_32x16 = aom_dc_predictor_32x16_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_predictor_32x32 = aom_dc_predictor_32x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_predictor_32x64 = aom_dc_predictor_32x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_predictor_64x64 = aom_dc_predictor_64x64_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_predictor_64x32 = aom_dc_predictor_64x32_avx2; //avx2/;
  if (flags & HAS_AVX2) aom_dc_predictor_64x16 = aom_dc_predictor_64x16_avx2; //avx2/;
  //
  ...
  //
  /*aom_highbd_v_predictor_4x4 =  sse2/;
  aom_highbd_v_predictor_4x8 =  sse2/;
  aom_highbd_v_predictor_8x4 =  sse2/;
  aom_highbd_v_predictor_8x8 =  sse2/;
  aom_highbd_v_predictor_8x16 =  sse2/;
  aom_highbd_v_predictor_16x8 =  sse2/;
  aom_highbd_v_predictor_16x16 =  sse2/;
  aom_highbd_v_predictor_16x32 =  sse2/;
  aom_highbd_v_predictor_32x16 =  sse2/;
  aom_highbd_v_predictor_32x32 =  sse2/;
  //
  aom_highbd_dc_predictor_4x4 =  sse2 neon/;
  aom_highbd_dc_predictor_4x8 =  sse2/;
  aom_highbd_dc_predictor_8x4 =  sse2/;;
  aom_highbd_dc_predictor_8x8 =  sse2 neon/;;
  aom_highbd_dc_predictor_8x16 =  sse2/;;
  aom_highbd_dc_predictor_16x8 =  sse2/;
  aom_highbd_dc_predictor_16x16 =  sse2 neon/;
  aom_highbd_dc_predictor_16x32 =  sse2/;
  aom_highbd_dc_predictor_32x16 =  sse2/;
  aom_highbd_dc_predictor_32x32 =  sse2 neon/;
  aom_highbd_dc_predictor_64x64 =  neon/;
  //
  aom_highbd_h_predictor_4x4 =  sse2/;
  aom_highbd_h_predictor_4x8 =  sse2/;
  aom_highbd_h_predictor_8x4 =  sse2/;
  aom_highbd_h_predictor_8x8 =  sse2/;
  aom_highbd_h_predictor_8x16 =  sse2/;
  aom_highbd_h_predictor_16x8 =  sse2/;
  aom_highbd_h_predictor_16x16 =  sse2/;
  aom_highbd_h_predictor_16x32 =  sse2/;
  aom_highbd_h_predictor_32x16 =  sse2/;
  aom_highbd_h_predictor_32x32 =  sse2/;
  //
  aom_highbd_dc_128_predictor_4x4 =  sse2/;
  aom_highbd_dc_128_predictor_4x8 =  sse2/;
  aom_highbd_dc_128_predictor_8x4 =  sse2/;
  aom_highbd_dc_128_predictor_8x8 =  sse2/;
  aom_highbd_dc_128_predictor_8x16 =  sse2/;
  aom_highbd_dc_128_predictor_16x8 =  sse2/;
  aom_highbd_dc_128_predictor_16x16 =  sse2/;
  aom_highbd_dc_128_predictor_16x32 =  sse2/;
  aom_highbd_dc_128_predictor_32x16 =  sse2/;
  aom_highbd_dc_128_predictor_32x32 =  sse2/;
  //
  aom_highbd_dc_left_predictor_4x4 =  sse2/;
  aom_highbd_dc_left_predictor_4x8 =  sse2/;
  aom_highbd_dc_left_predictor_8x4 =  sse2/;
  aom_highbd_dc_left_predictor_8x8 =  sse2/;
  aom_highbd_dc_left_predictor_8x16 =  sse2/;
  aom_highbd_dc_left_predictor_16x8 =  sse2/;
  aom_highbd_dc_left_predictor_16x16 =  sse2/;
  aom_highbd_dc_left_predictor_16x32 =  sse2/;
  aom_highbd_dc_left_predictor_32x16 =  sse2/;
  aom_highbd_dc_left_predictor_32x32 =  sse2/;
  //
  aom_highbd_dc_top_predictor_4x4 =  sse2/;
  aom_highbd_dc_top_predictor_4x8 =  sse2/;
  aom_highbd_dc_top_predictor_8x4 =  sse2/;
  aom_highbd_dc_top_predictor_8x8 =  sse2/;
  aom_highbd_dc_top_predictor_8x16 =  sse2/;
  aom_highbd_dc_top_predictor_16x8 =  sse2/;
  aom_highbd_dc_top_predictor_16x16 =  sse2/;
  aom_highbd_dc_top_predictor_16x32 =  sse2/;
  aom_highbd_dc_top_predictor_32x16 =  sse2/;
  aom_highbd_dc_top_predictor_32x32 =  sse2/;*/
  //
#endif
#if defined(__SSSE3__) && HAVE_SIMD
